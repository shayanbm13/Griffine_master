...
class MusicAdapter private constructor(private val context: Context) : RecyclerView.Adapter<MusicAdapter.ViewHolder>() {
    ...
    var musicList= com.example.griffin.mudels.musicList
...
//            for (item in musicList){
            ...
            val index = com.example.griffin.mudels.musicList.indexOf(musicInfo)
            var old_list = com.example.griffin.mudels.musicList

            old_list[index] = musicInfo

            com.example.griffin.mudels.musicList= old_list
            val musicPlayer = Music_player.getInstance(context)
            musicPlayer.playMusic(musicInfo.audioUrl)
            com.example.griffin.mudels.musicList=old_list


            println(com.example.griffin.mudels.musicList)

            notifyDataSetChanged()
            updateAdapterValue(com.example.griffin.mudels.musicList)
...
//            println(scenario_side)
    ...
    private fun hideAllWaveGifs() {
        ...
        var new_list= com.example.griffin.mudels.musicList
        ...
        com.example.griffin.mudels.musicList= new_list as MutableList<MusicModel>
