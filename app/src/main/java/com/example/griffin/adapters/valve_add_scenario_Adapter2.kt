...
class valve_add_scenario_Adapter2(
...
) : RecyclerView.Adapter<valve_add_scenario_Adapter2.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: valve) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                if (selectedItems?.contains(item.Vname) == true || clickStates[position]) {
