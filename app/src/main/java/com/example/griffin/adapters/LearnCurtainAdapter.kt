...
class LearnCurtainAdapter(
    private var items: List<curtain?>,
    private val onItemClick: (curtain) -> Unit
) : RecyclerView.Adapter<LearnCurtainAdapter.ViewHolder>() {

//    private val resetClickStatesListener: () -> Unit = {
//        // فراخوانی تابع resetClickStates از داخل LearnCurtainAdapter
//        resetClickStates()
//    }
