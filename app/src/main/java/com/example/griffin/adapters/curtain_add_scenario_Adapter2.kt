...
class curtain_add_scenario_Adapter2(
...
) : RecyclerView.Adapter<curtain_add_scenario_Adapter2.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: curtain) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                if (selectedItems?.contains(item.Cname) == true || clickStates[position]) {
