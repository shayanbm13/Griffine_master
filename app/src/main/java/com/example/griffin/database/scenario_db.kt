    ...
    class Scenario_db private constructor(context: Context) : SQLiteOpenHelper(context,"Scenario_db",null,1) {
        override fun onCreate(db: SQLiteDatabase?) {
            val CREATE_Scenario_db =
                "CREATE TABLE IF NOT EXISTS " + "Scenario_db" + "(id INTEGER PRIMARY KEY , light TEXT, thermostat TEXT, curtain TEXT, valve TEXT, fan TEXT, plug TEXT, scenario_name TEXT, music TEXT, in_ex TEXT )"
        ...
        fun get_from_db_scenario_By_name(name: String?): scenario? {
            ...
            val cursor = db.query(
                "Scenario_db",
                arrayOf("id" , "light", "thermostat", "curtain", "valve" , "fan" , "plug" , "scenario_name", "music", "in_ex"),
                "scenario_name=?",
