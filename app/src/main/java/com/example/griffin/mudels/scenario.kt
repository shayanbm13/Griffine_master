...
class scenario() {
    ...
    var id:Int?=null
    constructor(light:String?,thermostat:String?,curtain:String?,valve:String?,fan:String?,plug:String,scenario_name:String,id:Int?,music:String,in_ex:String) : this(){
        this.light=light
