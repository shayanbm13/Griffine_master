...
class plug_add_scenario_Adapter2(
...
) : RecyclerView.Adapter<plug_add_scenario_Adapter2.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: Plug) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                if (selectedItems?.contains(item.Pname) == true || clickStates[position]) {
